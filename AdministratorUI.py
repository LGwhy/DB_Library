...
class Ui_administrator(object):
    def setupUi(self, administrator):
        ...
        administrator.resize(738, 747)
        self.tabWidget = QtWidgets.QTabWidget(administrator)
    ...
    def retranslateUi(self, administrator):
        ...
        administrator.setWindowTitle(_translate("administrator", "系统管理员系统"))
        self.label.setText(_translate("administrator", "读者ID"))
        self.label_2.setText(_translate("administrator", "姓名"))
        self.label_4.setText(_translate("systemadmin", "学院"))
        self.unit.setItemText(0, _translate("systemadmin", "信息工程学院"))
        self.unit.setItemText(1, _translate("systemadmin", "资源与环境学院"))
        self.unit.setItemText(2, _translate("systemadmin", "水利学院"))
        self.unit.setItemText(3, _translate("systemadmin", "水资源学院"))
        self.unit.setItemText(4, _translate("systemadmin", "公共管理学院"))
        self.unit.setItemText(5, _translate("systemadmin", "管经学院"))
        self.unit.setItemText(6, _translate("systemadmin", "外国语学院"))
        self.unit.setItemText(7, _translate("systemadmin", "国际教育学院"))
        self.unit.setItemText(8, _translate("systemadmin", "建筑学院"))
        self.unit.setItemText(9, _translate("systemadmin", "数学与统计学院"))
        self.unit.setItemText(10, _translate("systemadmin", "创新创业学院"))
        self.unit.setItemText(11, _translate("systemadmin", "土木学院"))
        self.unit.setItemText(12, _translate("systemadmin", "电力学院"))
        self.unit.setItemText(13, _translate("systemadmin", "机械学院"))
        self.label_3.setText(_translate("administrator", "性别"))
        self.sex.setItemText(0, _translate("administrator", "男"))
        self.sex.setItemText(1, _translate("administrator", "女"))
        self.label_6.setText(_translate("administrator", "读者类型"))
        self.readtype.setItemText(0, _translate("administrator", "本科生"))
        self.readtype.setItemText(1, _translate("administrator", "研究生"))
        self.readtype.setItemText(2, _translate("administrator", "教师"))
        self.label_7.setText(_translate("administrator", "可借册数"))
        self.label_8.setText(_translate("administrator", "已借册数"))
        self.label_9.setText(_translate("administrator", "欠款"))
        self.addr.setText(_translate("administrator", "添加"))
        self.alterr.setText(_translate("administrator", "修改"))
        self.deleter.setText(_translate("administrator", "删除"))
        item = self.readerinfos.horizontalHeaderItem(0)
        item.setText(_translate("administrator", "读者ID"))
        item = self.readerinfos.horizontalHeaderItem(1)
        item.setText(_translate("administrator", "姓名"))
        item = self.readerinfos.horizontalHeaderItem(2)
        item.setText(_translate("administrator", "性别"))
        item = self.readerinfos.horizontalHeaderItem(3)
        item.setText(_translate("administrator", "学院"))
        item = self.readerinfos.horizontalHeaderItem(4)
        item.setText(_translate("administrator", "读者类型"))
        item = self.readerinfos.horizontalHeaderItem(5)
        item.setText(_translate("administrator", "可借册数"))
        item = self.readerinfos.horizontalHeaderItem(6)
        item.setText(_translate("administrator", "在借册数"))
        item = self.readerinfos.horizontalHeaderItem(7)
        item.setText(_translate("administrator", "密码"))
        item = self.readerinfos.horizontalHeaderItem(8)
        item.setText(_translate("administrator", "欠款"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("administrator", "读者信息录入"))
        item = self.admininfos.horizontalHeaderItem(0)
        item.setText(_translate("administrator", "I D"))
        ...
        item.setText(_translate("administrator", "密码"))
        self.adda.setText(_translate("administrator", "添加"))
        self.altera.setText(_translate("administrator", "修改"))
        self.deletea.setText(_translate("administrator", "删除"))
        self.label_11.setText(_translate("administrator", "姓名"))
        self.label_10.setText(_translate("administrator", "I D"))
        self.label_12.setText(_translate("administrator", "密码"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("administrator", "图书管理员信息录入"))
    ...
    def addreader(self):
        ...
        if res:
            ...
            sql='INSERT INTO readers(`ID`, `姓名`, `性别`, `学院`, `读者类型`, `可借册数`, `在借册数`) VALUES ("%s","%s","%s","%s","%s",%d,%d);' %value
            cursor.execute(sql)
            conn.commit()
    ...
    def alterreader(self):
        ...
        sql = 'UPDATE readers SET 姓名="%s",性别="%s",学院="%s",读者类型="%s",可借册数=%d,在借册数=%d,欠款=%.2f WHERE ID="%s"' % value
        cursor.execute(sql)
        conn.commit()
