...
class Ui_Librarian(object):
    def setupUi(self, librarian):
        librarian.setObjectName("librarian")#设置窗口名
        librarian.resize(854, 787)#设置窗口大小
        self.tabWidget = QtWidgets.QTabWidget(librarian)#设置选项卡，并加入到窗口中
        self.tabWidget.setGeometry(QtCore.QRect(20, 20, 811, 761))#设置选项卡的大小和位置
        self.tabWidget.setObjectName("tabWidget")#设置选项卡名
        ...
        self.retranslateUi(librarian)
        self.tabWidget.setCurrentIndex(2)
        QtCore.QMetaObject.connectSlotsByName(librarian)
    ...
    def retranslateUi(self, librarian):
        _translate = QtCore.QCoreApplication.translate
        librarian.setWindowTitle(_translate("librarian", "图书管理员系统"))
        self.label_2.setText(_translate("librarian", "读者ID"))
        self.label.setText(_translate("librarian", "姓名"))
        self.label_3.setText(_translate("librarian", "学院"))
        self.select.setText(_translate("librarian", "查询"))
        self.selectall.setText(_translate("librarian", "显示所有"))
        item = self.readerinfors.horizontalHeaderItem(0)
        item.setText(_translate("librarian", "读者ID"))
        item = self.readerinfors.horizontalHeaderItem(1)
        item.setText(_translate("librarian", "姓名"))
        item = self.readerinfors.horizontalHeaderItem(2)
        item.setText(_translate("librarian", "性别"))
        item = self.readerinfors.horizontalHeaderItem(3)
        item.setText(_translate("librarian", "学院"))
        item = self.readerinfors.horizontalHeaderItem(4)
        item.setText(_translate("librarian", "读者类型"))
        item = self.readerinfors.horizontalHeaderItem(5)
        item.setText(_translate("librarian", "可借册数"))
        item = self.readerinfors.horizontalHeaderItem(6)
        item.setText(_translate("librarian", "在借册数"))
        item = self.readerinfors.horizontalHeaderItem(7)
        item.setText(_translate("librarian", "欠款"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("librarian", "查询读者信息"))
        self.label_4.setText(_translate("librarian", "ISBN号"))
        self.label_5.setText(_translate("librarian", "书名"))
        self.label_6.setText(_translate("librarian", "作者"))
        self.label_7.setText(_translate("librarian", "类型"))
        self.label_8.setText(_translate("librarian", "价  格"))
        self.label_9.setText(_translate("librarian", "出版社"))
        self.label_12.setText(_translate("librarian", "在馆册数"))
        self.label_11.setText(_translate("librarian", "馆藏册数"))
        self.label_10.setText(_translate("librarian", "摘  要"))
        self.label_13.setText(_translate("librarian", "书架号"))
        self.addbook.setText(_translate("librarian", "添加"))
        self.deletebook.setText(_translate("librarian", "删除"))
        self.alterbook.setText(_translate("librarian", "修改"))
        item = self.bookinfos.horizontalHeaderItem(0)
        item.setText(_translate("librarian", "ISBN号"))
        item = self.bookinfos.horizontalHeaderItem(1)
        item.setText(_translate("librarian", "书名"))
        item = self.bookinfos.horizontalHeaderItem(2)
        item.setText(_translate("librarian", "作者"))
        item = self.bookinfos.horizontalHeaderItem(3)
        item.setText(_translate("librarian", "类型"))
        item = self.bookinfos.horizontalHeaderItem(4)
        item.setText(_translate("librarian", "价  格"))
        item = self.bookinfos.horizontalHeaderItem(5)
        item.setText(_translate("librarian", "出版社"))
        item = self.bookinfos.horizontalHeaderItem(6)
        item.setText(_translate("librarian", "摘  要"))
        item = self.bookinfos.horizontalHeaderItem(7)
        item.setText(_translate("librarian", "馆藏册数"))
        item = self.bookinfos.horizontalHeaderItem(8)
        item.setText(_translate("librarian", "在馆册数"))
        item = self.bookinfos.horizontalHeaderItem(9)
        item.setText(_translate("librarian", "书架号"))
        item = self.bookinfos.horizontalHeaderItem(10)
        item.setText(_translate("librarian", "被借次数"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("librarian", "管理书籍信息"))
        ...
        item.setText(_translate("librarian", "借/还"))
        item = self.iteminfo.horizontalHeaderItem(3)
        item.setText(_translate("librarian", "时间"))
        self.yes.setText(_translate("librarian", "批准"))
        self.no.setText(_translate("librarian", "驳回"))
        self.refresh.setText(_translate("librarian", "刷新"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("librarian", "借阅/归还审批"))
        ...
        try:
            ...
            if prize1 != '':
                ...
                if bookid and bookname and author and booktype and prize and press and totalnum and num and abstract_2 and bookshelf:
                    sql = 'insert into books(ISBN号,书名,作者,类型,价格,出版社,摘要,馆藏册数,在馆册数,书架号,被借次数) values' \
                          ' ("%s","%s","%s","%s","%.2f","%s","%s","%d","%d","%s","%d")' % (bookid,bookname,author,booktype,
                            prize,press,abstract_2,num,totalnum,bookshelf,0)
                    cursor.execute(sql)
                    conn.commit()
                    self.show_all_books()
                else:
    ...
    def update_book(self):
        ...
        try:
            ...
            if prize1 != '':
                prize = float(prize1)
                if bookid and bookname and author and booktype and prize and press and totalnum and num and abstract_2 and bookshelf:
                    sql = 'UPDATE books SET ISBN号="%s",书名="%s",作者="%s",类型="%s",价格="%.2f",出版社="%s",摘要="%s",' \
                          '馆藏册数="%d",在馆册数="%d",书架号="%s",被借次数="%d" WHERE ISBN号="%s"' % (bookid,bookname,
                           author,booktype,prize,press,abstract_2,num,totalnum,bookshelf,0,bookid)
                    cursor.execute(sql)
                    conn.commit()
                    self.show_all_books()
                else:
...
#******************************************************借阅归还审批功能****************************************************
    ...
    def pizhun(self):
        ...
        if selecttype == 'borrow':
            ...
            cursor.execute(sql1)
            conn.commit()
            sql2 = 'insert into borrow(ID,ISBN号,借书时间) values ("%s","%s","%s")'%(readerid,bookid,itemtime)
            cursor.execute(sql2)
            conn.commit()
            ...
            conn.commit()
            #图书被借册数加一
            sql4 = 'update books set 被借次数=被借次数+1,在馆册数=在馆册数-1 where ISBN号="%s"'%(bookid)
            cursor.execute(sql4)
            conn.commit()
        else:
            sql = 'select * from borrow where ID="%s" and ISBN号="%s"'%(readerid,bookid)
            cursor.execute(sql)
            ...
            sql5 = 'delete from borrow where ISBN号="%s"'%(bookid)
            cursor.execute(sql5)
            conn.commit()
            ...
            cursor.execute(sql9)
            conn.commit()
            sql10 = 'update books set 在馆册数=在馆册数+1 where ISBN号="%s"'%(bookid)
