...
class Ui_Reader(object):
    ...
    def retranslateUi(self, Reader):
        ...
        self.label.setText(_translate("Reader", "ISBN号/书名"))
        ...
        item.setText(_translate("Reader", "ISBN号"))
        ...
        self.returnbo.setText(_translate("Reader", "ISBN号"))
        ...
        self.label_3.setText(_translate("Reader", "书  名"))
        self.label_4.setText(_translate("Reader", "ISBN号"))
        self.label_5.setText(_translate("Reader", "作  者"))
        self.label_6.setText(_translate("Reader", "类  别"))
        self.label_7.setText(_translate("Reader", "出版社"))
        self.pushButton.setText(_translate("Reader", "查询所有书籍"))
        ...
        self.label_12.setText(_translate("Reader", "您已逾期，需支付罚款："))
        self.alipay.setText(_translate("Reader", "手机支付"))
        self.wepay.setText(_translate("Reader", "现金支付"))
    ...
    def borrowidcheck(self):
        ...
        sql='select * from books where ISBN号="%s" or 书名="%s"'% (bookin,bookin)
    ...
    def ReturnBook(self):
        ...
        res=cursor.execute(sql)
        if res:
            sql = 'SELECT * from borrow where ISBN号="%s" and ID="%s"' % (bookid, self.loginID)
            res = cursor.execute(sql)
    ...
    def selectbook(self):
        ...
        if bookid:
            if an==1:
                bookid=' and ISBN号="%s"' %(bookid)
            else:
                bookid = ' ISBN号="%s"' % (bookid)
                an=1
        if bookauthor:
            if an == 1:
